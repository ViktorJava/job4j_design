 ...
 * </ul>
 * <p>Также, реализовать интерфейс Iterable.
 * Метод {@code iterator()} возвращает итератор, предназначенный
 * для обхода данной структуры.
 * <p>
 * Объект должен принимать количество ячеек. Структура не должна
 * быть динамической.
 * <ul>
 * <li>1. В методах, где используется индекс нужно делать валидацию.
 ...
 * <li>2. Для удаления использовать {@code System.arraycopy()} вместо цикла.</li>
 *</ul>
